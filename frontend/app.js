...
const marketsFilterState = { search: '', category: 'All' };
...
const routes = [
  ...
  { pattern: /^#\/history$/, handler: renderHistory, auth: true },
  { pattern: /^#\/api-keys$/, handler: renderApiKeys, auth: true },
  { pattern: /^#\/account$/, handler: renderAccount, auth: true },
